...
| [Project Management Charter + Proposal]() | Fictitious company requires 100,000 sq. ft. warehouse be built, tasking our team with designing and proposing project plan and charter. | Project Management Skills: Scope management plan, staffing/schedule management, project charter, Gantt chart, cost-benefit analysis, RACI requirements assignment matrix, risk assessment, SWOT analysis, task prioritization. |
